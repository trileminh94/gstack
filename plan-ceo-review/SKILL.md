...
|------|-------------------|
| consulting the mode comparison table during Step 0F mode selection | `sections/mode-reference.md` |
| running the 11 review sections after mode selection (Step 0F) | `sections/review-sections.md` |
...
> **STOP.** Before consulting the mode comparison table during Step 0F mode selection, Read `~/.claude/skills/gstack/plan-ceo-review/sections/mode-reference.md` and execute it
...
> **STOP.** Before running the 11 review sections after mode selection (Step 0F), Read `~/.claude/skills/gstack/plan-ceo-review/sections/review-sections.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.
